...
**Caso de uso (diagrama)**: `Reportar cancelación de reserva` (informa al Módulo 3) — óvalo introducido en el diagrama 3 y conservado en el vigente `unimag5.png`, fuente en `unimag5.drawio`
**Prioridad global**: P2
