...
- **FR-016**: Al confirmar una reserva, el sistema DEBE ejecutar siempre `Reportar información de la reserva`, sin que el usuario tenga que pedirlo y sin posibilidad de omitirlo.
