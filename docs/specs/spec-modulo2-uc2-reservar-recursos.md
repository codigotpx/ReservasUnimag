...
- **FR-004**: El sistema DEBE garantizar que no existan dos ocupaciones confirmadas solapadas sobre el mismo recurso, incluso bajo solicitudes concurrentes. Vale igual para dos franjas de un espacio, para dos periodos de préstamo de un objeto y para la mezcla de ambos con un bloqueo académico: lo que no puede cruzarse es el tiempo ocupado, sea de dos horas o de siete días.
...
- **FR-010**: El sistema DEBE liberar el recurso y dejar constancia de la ausencia **cuando el Módulo 3 le reporte que la persona no se presentó**, nunca por su cuenta; la sanción la decide y la aplica ese mismo módulo. El reporte solo se admite pasados 10 minutos, contados desde el inicio de la franja cuando se trata de un **espacio** y desde la hora de recogida cuando se trata de un **objeto**: si alguien aparta un videobeam para las 14:30 y no aparece, a partir de las 14:40 el Módulo 3 puede reportarlo, y con ese aviso se cancela el periodo de préstamo completo —no solo esos diez minutos— y el objeto vuelve a `DISPONIBLE`. Mientras no llegue el reporte, el recurso sigue apartado. Ver `Reportar no asistencia`.
