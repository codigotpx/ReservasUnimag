...
5. **Scenario**: El activo está prestado
...
- **FR-012**: Cuando el recurso no esté disponible, el sistema DEBE indicar **hasta cuándo** está comprometido: el fin de la franja que lo ocupa si es un espacio, y la fecha de vencimiento del préstamo si es un activo. Así quien pregunta puede decidir si espera o busca otra cosa. Esa fecha no identifica a nadie, de modo que no contradice FR-005.

### Key Entities

- **Recurso**: espacio o activo por el que se pregunta.
- **FranjaHoraria**: día con hora de inicio y hora de fin sobre la que se pregunta; siempre es de un solo día, también cuando se pregunta por un activo.
- **PeriodoDePrestamo**: el tiempo continuo, de posiblemente varios días, que un activo pasa prestado. Es una de las ocupaciones contra las que se cruza la franja preguntada.
